...
public static function dadosBoleto($dadosboleto){
...
public function digitoVerificador_barra($numero) {
	$resto2 = Boleto::modulo_11($numero, 9, 1);
	$digito = 11 - $resto2;
...
$f2 = '';
  ...
  //impressões por linhas
$il = '<img src="/res/img/boleto/p.png" width="'.$fino.'" height="'.$altura.'" border=0>
<img src=/res/img/boleto/b.png width="'.$fino.'" height="'.$altura.'" border=0>
<img src=/res/img/boleto/p.png width="'.$fino.'" height="'.$altura.'" border=0>
<img src=/res/img/boleto/b.png width="'.$fino.'" height="'.$altura.'" border=0>';
...
while (strlen($texto) > 0){
    $i = round(Boleto::esquerda($texto, 2));
    $texto = Boleto::direita($texto, strlen($texto)-2);
    $f = $barcodes[$i];
    ...
    for($i = 1; $i < 11; $i +=2){
        ...
        $il = $il.'<img src=/res/img/boleto/p.png width="'.$f1.'" height="'.$altura.'" border=0>';
        ...
        $il = $il.'<img src=/res/img/boleto/b.png width="'.$f2.'" height="'.$altura.'" border=0>';
    }
}


$il = $il.'<img src=/res/img/boleto/p.png width="'.$largo.'" height="'.$altura.'" border=0>
<img src=/res/img/boleto/b.png width="'.$fino.'" height="'.$altura.'" border=0>
<img src=/res/img/boleto/p.png width="'.$fino.'" height="'.$altura.'" border=0>'; 
...
public function fator_vencimento($data) {
	...
	$mes = $data[1];
	$dia = $data[0];
    return(abs((Boleto::_dateToDays("1997","10","07")) - (Boleto::_dateToDays($ano, $mes, $dia))));
}
...
public function monta_linha_digitavel($codigo) {
		...
		$dv3      = Boleto::modulo_10($resag.$contadac.$zeros);
		// campo 4
...
public function geraCodigoBanco($numero) {
    ...
    $parte2 = Boleto::modulo_11($parte1);
