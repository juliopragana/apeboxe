...
$.extend( $.validator.messages, {
	...
	// Core
	required: "<span style='color:red;'> Este campo &eacute; requerido.</span>",
	remote: "Por favor, corrija este campo.",
	email: "<span style='color:red;'> Por favor, forne&ccedil;a um endere&ccedil;o de email v&aacute;lido. </span>",
	url: "Por favor, forne&ccedil;a uma URL v&aacute;lida.",
	date: "Por favor, forne&ccedil;a uma data v&aacute;lida.",
	dateISO: "Por favor, forne&ccedil;a uma data v&aacute;lida (ISO).",
	number: "<span style='color:red;'> Por favor, forne&ccedil;a apenas n&uacute;meros. </span>",
	digits: "Por favor, forne&ccedil;a somente d&iacute;gitos.",
	creditcard: "Por favor, forne&ccedil;a um cart&atilde;o de cr&eacute;dito v&aacute;lido.",
	equalTo: "Por favor, forne&ccedil;a o mesmo valor novamente.",
	maxlength: $.validator.format( " <span style='color:red;'> Por favor, forne&ccedil;a n&atilde;o mais que {0} caracteres.</span>" ),
	minlength: $.validator.format( "<span style='color:red;'> Por favor, forne&ccedil;a ao menos {0} caracteres.</span>" ),
	rangelength: $.validator.format( "Por favor, forne&ccedil;a um valor entre {0} e {1} caracteres de comprimento.</span>" ),
	range: $.validator.format( "Por favor, forne&ccedil;a um valor entre {0} e {1}." ),
	max: $.validator.format( "Por favor, forne&ccedil;a um valor menor ou igual a {0}." ),
	min: $.validator.format( "<span style='color:red;'> Por favor, forne&ccedil;a um valor maior ou igual a {0}.</span>" ),
	step: $.validator.format( "Por favor, forne&ccedil;a um valor m&acute;tiplo de {0}." ),

	// Metodos Adicionais
	maxWords: $.validator.format( "Por favor, forne&ccedil;a com {0} palavras ou menos." ),
	minWords: $.validator.format( "Por favor, forne&ccedil;a nome e sobrenome	." ),
	rangeWords: $.validator.format( "Por favor, forne&ccedil;a entre {0} e {1} palavras." ),
	accept: "<span style='color:red;'> Por favor, fazer upload somente de images (jpg, png, gif).</span>",
